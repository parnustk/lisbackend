 ...
 */
class AbsenceReason extends \Core\Entity\AbsenceReason implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'absence', 'trashed', 'createdBy', 'updatedBy', 'createdAt', 'updatedAt', 'VF', 'form', 'doctrineHydrator', 'entityManager');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AbsenceReason $proxy) {
