...
abstract class AbstractAdministratorBaseController extends AbstractBaseController
{
    ...
    /**
     * 
     * @param Administrator $lisPerson
     * @return \Core\Controller\AbstractStudentBaseController
     */
    public function setlisPerson(Administrator $lisPerson)
    {
    ...
    protected function checkUserSession()
    {
        ...
        try {
            ...
            $lisPerson = $this->getEntityManager()->getRepository('Core\Entity\Administrator')->find($storage['lisPerson']);
            if (!($lisPerson instanceof \Core\Entity\Administrator)) {
