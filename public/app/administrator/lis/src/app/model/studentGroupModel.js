...
(function (define, window) {
    ...
    define([
         ...
         * @param {type} $http
         * @param {type} $resource
         * @returns {studentGroupModel_L21.studentGroupModel.studentGroupModelAnonym$3}
         */
        function studentGroupModel($http, $resource) {
        ...
        studentGroupModel.$inject = ['$http', '$resource'];
