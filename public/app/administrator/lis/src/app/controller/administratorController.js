...
(function (define, document) {
    ...
    define(['angular', 'app/util/globalFunctions'],
        function (angular, globalFunctions) {
            ...
            administratorController.$inject = ['$scope', '$q' ,'$cookies' , 'uiGridConstants', 'administratorModel'];
             ...
             */
            function administratorController($scope, $q, $cookies, uiGridConstants, administratorModel) {
                ...
                if (cRaw) {
                    ...
                    if (uInf.hasOwnProperty('superuser')) {
                        $scope.superuser = uInf.superuser;
                ...
                $scope.gridOptions = {
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            enableCellEdit: $scope.superuser
                        },
                        {
                            field: 'lastName',
                ...
                function LoadGrid() {
                    ...
                    administratorModel.GetList(urlParams).then(function (result) {
                        if (globalFunctions.resultHandler(result)) {
