...
(function (define, document) {
    ...
    define(['angular', 'app/util/globalFunctions'],
        function (angular, globalFunctions) {
            ...
            independentWorkController.$inject = ['$scope', '$q', '$routeParams', 'rowSorter', 'uiGridConstants', 'independentWorkModel', 'subjectRoundModel', 'teacherModel', 'studentModel'];
            /**
             * 
             * @param {type} $scope
             * @param {type} $q
             ...
             * @returns {undefined}
             */
            function independentWorkController($scope, $q, $routeParams, rowSorter, uiGridConstants, independentWorkModel, subjectRoundModel, teacherModel, studentModel) {
