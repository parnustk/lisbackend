...
(function (define, window) {
    ...
    define([
         ...
         * @param {type} $http
         * @param {type} $resource
         * @returns {independentWorkModel_L19.independentWorkModel.independentWorkModelAnonym$3}
         */
        function independentWorkModel($http, $resource) {

            var _model;
            
            _model = $resource(
                window.LisGlobals.RestUrl + 'independentWork/:id',
                {id: '@id'},
                {
                    update: {method: "PUT"},
        ...
        independentWorkModel.$inject = ['$http', '$resource'];
        return independentWorkModel;
    });
