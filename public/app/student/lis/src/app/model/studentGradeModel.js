...
(function (define, window) {
    ...
    define([
         ...
         * @param {type} $http
         * @param {type} $resource
         * @returns {studentGradeModel_L19.studentGradeModel.studentGradeModelAnonym$3}
         */
        function studentGradeModel($http, $resource) {

            var _model;
            
            _model = $resource(
                window.LisGlobals.RestUrl + 'studentGrade/:id',
                {id: '@id'},
                {
                    update: {method: "PUT"},
        ...
        studentGradeModel.$inject = ['$http', '$resource'];
