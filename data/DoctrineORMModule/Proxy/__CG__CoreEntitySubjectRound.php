...
class SubjectRound extends \Core\Entity\SubjectRound implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'independentWork', 'contactLesson', 'gradeSubjectRound', 'subject', 'studentGroup', 'teacher', 'trashed', 'VF', 'form', 'doctrineHydrator', 'entityManager', 'algoKey');
        }
    ...
    public function getGradeSubjectRound()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGradeSubjectRound', array());

        return parent::getGradeSubjectRound();
    }
    ...
    public function setGradeSubjectRound($gradeSubjectRound)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGradeSubjectRound', array($gradeSubjectRound));

        return parent::setGradeSubjectRound($gradeSubjectRound);
    }
