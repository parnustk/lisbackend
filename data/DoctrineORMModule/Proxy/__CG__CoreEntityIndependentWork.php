 ...
 */
class IndependentWork extends \Core\Entity\IndependentWork implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'duedate', 'name', 'description', 'durationAK', 'studentGrade', 'subjectRound', 'teacher', 'trashed', 'createdBy', 'updatedBy', 'createdAt', 'updatedAt', 'VF', 'form', 'doctrineHydrator', 'entityManager');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IndependentWork $proxy) {
