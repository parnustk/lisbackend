 ...
 */
class Vocation extends \Core\Entity\Vocation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'code', 'durationEKAP', 'studentGroup', 'module', 'trashed', 'VF', 'form', 'doctrineHydrator', 'entityManager');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Vocation $proxy) {
    ...
    public function getDurationEKAP()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDurationEKAP', array());

        return parent::getDurationEKAP();
    }
    ...
    public function setDurationEKAP($durationEKAP)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDurationEKAP', array($durationEKAP));

        return parent::setDurationEKAP($durationEKAP);
    }
